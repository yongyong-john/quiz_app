...
import 'package:quiz_app/widget/candidate_widget.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  List<Widget> _buildCandidates(double width, Quiz quiz) {
    Widget buildCandidateWidget(int index) {
      return Container(
        padding: EdgeInsets.all(width * 0.024),
        child: CandidateWidget(
            ...
            setState(() {
              for (int j = 0; j < 4; j++) {
                if (j == index) {
                  ...
                  print('answer=${_answers[_currentIndex]}');
                } else {
          ...
          text: quiz.candidates[index],
          index: index,
          width: width,
          answerState: _answerState[index],
        ),
      );
    }

    List<Widget> children = List.generate(4, buildCandidateWidget);
